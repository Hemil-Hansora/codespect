...
export const RepositoriesList = () => {
  ...
  if (isLoading) {
    return (
      <Card className="h-full border border-border/50 bg-card/40 p-0 shadow-sm backdrop-blur-sm">
        <CardHeader className="pt-0 pb-4 space-y-1 shrink-0">
  ...
  return (
    <Card className="h-full border border-border/50 bg-card/40 p-0 shadow-sm backdrop-blur-sm">
      <CardHeader className="pt-0 pb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4 space-y-0 shrink-0">
      ...
      <CardContent className="flex-1 min-h-0 pb-6">
        {!repositories || repositories.length === 0 ? (
          <div className="flex min-h-[18rem] flex-col items-center justify-center rounded-2xl border border-dashed border-border/70 bg-muted/30 px-4 text-center">
          ...
          <ScrollArea className="h-[min(60vh,36rem)] w-full pr-2 sm:pr-4">
            <div className="space-y-3 pb-2 sm:pb-4">
